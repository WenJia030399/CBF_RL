...
from train_for_final_step2 import CBFWrapper, make_env as make_env_from_train  # 確保對應 train.py
...
if __name__ == "__main__":
    model_path = r"/home/wenjia/CBFRL/origin/final/low_level/logs/ppo_cbf_1765783241/best_model.zip"
