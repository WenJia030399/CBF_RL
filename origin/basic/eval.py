...
from train_for_final import CBFWrapper, make_env as make_env_from_train  # 確保對應 train.py
...
if __name__ == "__main__":
    model_path = r"/home/wenjia/CBFRL/logs/ppo_cbf_1765601078/best_model.zip"
